...
from .infer.utils_infer import transcribe
...
path_data = str(files(__package__ or "f5_tts").joinpath("../../data"))
path_project_ckpts = str(files(__package__ or "f5_tts").joinpath("../../ckpts"))
file_train = str(files(__package__ or "f5_tts").joinpath("train/finetune_cli.py"))
